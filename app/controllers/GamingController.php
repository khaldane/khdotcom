...
//        
		...
		return View::make('pages.gaming.gaming', array('character' => $character[0], 'characters' => $characters, 'stats' => json_decode($stats), 'pets' => json_decode($pets), 'mounts' => json_decode($mounts), 'achievements' => json_decode($achievements)));
	}
